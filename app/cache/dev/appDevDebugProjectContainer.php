...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_dbcd80f90304d81eb27965678b0e905c7ee94ec3178f8efb8ca29f9374d71af0');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('localhost' => 'localhost'), 'resetting' => array('localhost' => 'localhost'))));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('cfff6f2a476797f8f9e6e6a955266c2afc076219');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'localhost',
            'mailer_password' => NULL,
            'secret' => 'cfff6f2a476797f8f9e6e6a955266c2afc076219',
            'locale' => 'en',
            ...
            'kernel.secret' => 'cfff6f2a476797f8f9e6e6a955266c2afc076219',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'localhost',
